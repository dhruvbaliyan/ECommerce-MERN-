...
export const createCheckoutSession = async (req, res) => {
  try {
    ...
    // Ensure Stripe minimum for INR is ₹50 → 5000 paise
    if (totalAmount < 5000) {
      return res.status(400).json({
        error: "Minimum checkout amount for Stripe is ₹50. Please add more products.",
    ...
    // Create a new coupon if totalAmount exceeds ₹20000 (₹20000 → 2,000,000 paise)
